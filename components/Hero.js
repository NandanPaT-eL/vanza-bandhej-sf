    ...
    <section id="top" className="relative overflow-hidden pt-16 pb-10 md:pt-24 md:pb-16">
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[420px] sm:h-[520px]">
          ...
          <div className="portrait absolute right-0 top-10 w-[72%] h-[85%] rounded-sm shadow-2xl flex items-end justify-center">
            <span className="text-cream/70 text-[11px] tracking-widest2 uppercase pb-4">
              Model photograph
            </span>
          </div>

          <div className="fabric fabric-haldi absolute left-0 bottom-0 w-[58%] h-[45%] rounded-sm shadow-xl z-10" />
